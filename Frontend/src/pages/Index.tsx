...
import { Activity, Clock, XCircle, Beaker, Zap, TrendingUp, Users, Brain, DollarSign, BookmarkPlus, BookmarkCheck } from "lucide-react";
      ...
      <main className="flex-1 p-6 space-y-6 overflow-auto">
          ...
          {projected && (
            <>
              <div className="bg-card border border-cyan-500/30 border-l-2 p-4 flex items-center gap-4">
                <div className="bg-cyan-500/10 text-cyan-400 p-2.5 rounded-sm">
              ...
              <div className="bg-card border border-emerald-500/30 border-l-2 p-4 flex items-center gap-4">
                <div className="bg-emerald-500/10 text-emerald-400 p-2.5 rounded-sm">
        ...
        {savedScenario && kpis && (
          (() => {
            ...
            if (
              savedScenario.kpis.conversionRate === currentKpis.conversionRate &&
              savedScenario.label === currentLabel
            ) return null;
            return (
              <ScenarioComparison
                scenarioA={savedScenario}
                scenarioB={{ label: currentLabel, kpis: currentKpis, projected, payload: { ...liveValues } }}
